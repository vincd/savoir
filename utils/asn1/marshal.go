...
func makeBody(value reflect.Value, params fieldParameters) (e encoder, err error) {
	...
	case reflect.Slice:
		...
		// Savoir: https://github.com/jcmturner/gofork/blob/dc7c13fece037a4a36e2b3c69db4991498d30692/encoding/asn1/marshal.go#L484
		...
		case 0:
			return bytesEncoder(nil), nil
		case 1:
			return makeField(v.Index(0), params)
		default:
			m := make([]encoder, l)
	...
	case reflect.String:
		// fmt.Printf("makeBody - case String: %s\n", params.stringType)
		...
		case TagGeneralString:
			// fmt.Printf("makeBody - case String - TagGeneralString\n")
...
func makeField(v reflect.Value, params fieldParameters) (e encoder, err error) {
	...
	// Savoir: https://github.com/jcmturner/gofork/blob/dc7c13fece037a4a36e2b3c69db4991498d30692/encoding/asn1/marshal.go#L567
	// Add Slice of strings
	...
	// fmt.Printf("makeField - params: %+v\n", params)
	if params.tag != nil {
		// fmt.Printf("makeField - tag: %+v\n", *params.tag)
